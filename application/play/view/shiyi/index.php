<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/shiyi/33.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/shiyi/22.jpg">
        </div>
    </div>
    ...
    <script>
        ...
        $(function () {
            $('#submitbtn').click(function(){
                ...
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+"&avatar="+avatar+"&select1="+select1+"&type="+type);
                $('#savetipsbox').show();
