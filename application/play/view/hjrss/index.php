<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/hjrss/sample.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            <div class="inputlist">
                <span class="short-inputname">本人</span>
                    <span class="short-input">
                        <input id="user-name" maxlength="4" type="text" class="input input-name" placeholder="请输入本人姓名">
                    </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">认怂对象</span>
                    <span class="short-input">
                        <input id="user-name1" maxlength="4" type="text" class="input input-name" placeholder="请输入认怂对象">
                    </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">欠酒杯数</span>
                    <span class="short-input">
                        <input id="user-name2" maxlength="4" type="text" class="input input-name" placeholder="请输入欠酒杯数">
                    </span>
            </div> 
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            ...
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/hjrss/sample.jpg">
        </div>
    </div>
    </body>
        ...
        $(function () {
            ...
            $('#submitbtn').click(function(){
               ...
               if (name2 == '') {
                ...
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+"&name1="+name1+"&name2="+name2);
                $('#savetipsbox').show();
