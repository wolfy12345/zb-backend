<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/caomei/sample.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">情人节快乐</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="情人节快乐" selected>情人节快乐</option>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/caomei/sample.jpg">
        </div>
    </div>
    <script>
        $(function () {
