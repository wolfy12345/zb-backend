<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/mydz/icon.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <input id="user-name1" maxlength="10" type="text" class="input input-name" placeholder="如马云点赞">
                </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">新闻概要：</span>
                <span class="short-input">
                    <input id="user-name2" maxlength="9" type="text" class="input input-name" placeholder="如见义勇为">
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/mydz/sample.jpg">
        </div>
    </div>
    <script>
