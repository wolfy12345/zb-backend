<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/qbcz/icon.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            <div class="inputlist">
                <span class="short-inputname">QQ昵称：</span>
                <span class="short-input">
                    <input id="user-name" maxlength="3" type="text" class="input input-name" placeholder="请输入QQ昵称">
                </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">QQ号：</span>
                <span class="short-input">
                    <input id="user-name1" type="text" class="input input-name" placeholder="请输入QQ号">
                </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">Q币数：</span>
                <span class="short-input">
                    <input id="user-name2" type="text" class="input input-name" placeholder="请输入Q币数">
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/qbcz/sample.jpg">
        </div>
    </div>
    <script>
