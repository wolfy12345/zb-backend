<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/wgmj/icon.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            <div class="inputlist">
                <span class="short-inputname">秘籍名称</span>
                <span class="short-input">
                    <input id="user-name" maxlength="4" type="text" class="input input-name" placeholder="请输入秘籍名称">
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/wgmj/sample.jpg">
        </div>
    </div>
    <script>
