<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/medfdx/icon.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            <div class="inputlist">
                ...
                <span class="short-input">
                    <input id="user-name" maxlength="4" type="text" class="input input-name" placeholder="请输入昵称">
                </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">运营商</span>
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">中国移动</span>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/medfdx/sample.jpg">
        </div>
    </div>
    <script>
