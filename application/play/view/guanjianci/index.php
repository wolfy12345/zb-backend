<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/guanjianci/example.png">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <input id="user-name" type="text" maxlength="4" value="<?php echo isset($_SESSION['nickname'])?$_SESSION['nickname']:'';?>" class="input input-name" placeholder="请输入昵称">
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/guanjianci/example.png">
        </div>
    </div>
    ...
    <script>
        ...
        $(function () {
            $('#submitbtn').click(function(){
                ...
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+"&avatar="+avatar+"&type="+type+'&num=<?php echo $this->data['num'];?>');
                $('#savetipsbox').show();
