<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/taobao/11.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">颜美活好价位低，陪吃陪喝陪玩乐！</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="颜美活好价位低，陪吃陪喝陪玩乐！" >颜美活好价位低，陪吃陪喝陪玩乐！</option>
                        <option value="良心经营，你的完美恋人！">良心经营，你的完美恋人！</option>
                        <option value="品质保障，买到就是赚到！">品质保障，买到就是赚到！</option>
                        <option value="仅此一件，欲购从速！">仅此一件，欲购从速！</option>
                        <option value="文能提笔控萝莉，武能床上定少妇！">文能提笔控萝莉，武能床上定少妇！</option>
                        <option value=" 青春荒唐不负你，包夜免费快走起！"> 青春荒唐不负你，包夜免费快走起！</option>
                    </select>
                </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">金额：</span>
                <span class="short-input">
                    <input id="user-amount" type="text" value="" class="input input-name" placeholder="请输入金额" maxlength="5">
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/taobao/22.jpg">
        </div>
    </div>
    ...
    <script>
        var headImg = "<?php echo $_SESSION['headimgurl']?$_SESSION['headimgurl']:$this->baseUrl.'/static/img/default.png';?>";
        document.getElementById("user-name").value = "<?php echo $_SESSION['nickname']?$_SESSION['nickname']:'';?>";
        var image = new Image();
        image.crossOrigin = '';
        image.onload = function () {
            var c = document.getElementById("upload-canvas");
        ...
        //头像
        $.ajax({
            url: "?c=upload&a=remote&url=<?php echo $_SESSION['headimgurl']?$_SESSION['headimgurl']:'';?>&openid=<?php echo $_SESSION['openid']?$_SESSION['openid']:'';?>&type=b&w=600&h=600",
            type: "get",
            processData: false,
            contentType: false,
            dataType: 'json',
    ...
    <script>
        ...
        $(function () {
            $('#submitbtn').click(function(){
                ...
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+"&avatar="+avatar+"&select1="+select1+"&amount="+amount+"&type="+type);
                $('#savetipsbox').show();
