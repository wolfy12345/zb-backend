<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/xgbq/icon.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/xgbq/example.jpg">
        </div>
    </div>
    <script>
        ...
        $(function () {
            ...
            $('#submitbtn').click(function(){
               ...
               // $('.footer-more').hide();
                $('.footer-ad2').hide();
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+'&num=<?php echo $this->data['num'];?>'+"&name1="+name1);
                $('#savetipsbox').show();
