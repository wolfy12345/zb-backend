<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/dansheng/show.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">我是男生</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="我是男生" selected>我是男生</option>
                        <option value="我是女生">我是女生</option>
                    </select>
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/dansheng/show.jpg">
        </div>
    </div>
    <script>
        ...
        $(function () {
            ...
            $('#submitbtn').click(function(){
                ...
                $('.footer-more').hide();
                $('.footer-ad2').hide();
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+"&sex="+select1);
                $('#savetipsbox').show();
