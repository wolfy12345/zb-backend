<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/lvjian/sample.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            <div class="inputlist">
                ...
                <span class="short-input">
                    <input id="user-name" type="text" maxlength="3" class="input input-name" placeholder="请输入姓名">
                </span>
            </div>
            <div class="inputlist">
                <span class="short-inputname">内容：</span>
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">去哪里都带着你</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="去哪里都带着你" selected>去哪里都带着你</option>
                        <option value="时时刻刻想着你">时时刻刻想着你</option>
                    </select>
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/lvjian/sample.jpg">
        </div>
    </div>
    <script>
        $(function () {
