<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/gaokaozkz/sample.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                <span class="short-inputname">所在高中：</span>
                <span class="short-input">
                    <input id="user-name2" type="text" maxlength="20" class="input input-name" placeholder="输入所在高中名称">
                </span>
            </div>

            <div class="inputlist">
                <span class="short-inputname">科目：</span>
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">文科综合</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="文科综合" selected>文科综合</option>
                        <option value="理科综合">理科综合</option>
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <span id="select-text2" class="analog-select" data-value="1">男</span>
                    <select class="select" id="select-list2" name="select2">
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/gaokaozkz/sample.jpg">
        </div>
    </div>
    <script>
        ...
        $(function () {
            ...
            $('#submitbtn').click(function(){
                ...
                $('.footer-more').hide();
                $('.footer-ad2').hide();
                $('#result').attr('src', "?m=play&c=<?php echo $this->ctl;?>&a=image&name="+name+"&select1="+select1+"&name2="+name2+"&select2="+select2);
                $('#savetipsbox').show();
