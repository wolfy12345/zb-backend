<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/zuliggj/sample.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                ...
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">资深屌丝价位</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="1" selected>资深屌丝价位</option>
                        <option value="2">普通屌丝价位</option>
                        <option value="3">普通白领价位</option>
                        <option value="4">社会精英价位</option>
                        <option value="5">高富帅or白富美价位</option>
                    </select>
                </span>
            </div>
        </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/zuliggj/sample.jpg">
        </div>
    </div>
    ...
    <script>
        $("input[type=file]").change(function () {
            ...
            lrz(this.files[0], {
                ...
                $.ajax({
                    url: "?c=upload&a=base&w=300&h=440",
                    type: "POST",
                    data: rst.formData,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $('#select-list1').on('change', function(){
            $('#select-text1').text($("#select-list1 option").eq($("#select-list1").attr("selectedIndex")).text() );
        });
        $(function () {
