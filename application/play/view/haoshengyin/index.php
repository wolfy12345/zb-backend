<?php echo $this->renderCommon('header_content');?>
    ...
    <div id="page1" class="box active">
        <div id="openexample" class="gameinfobox">
            <img src="<?php echo $this->baseUrl;?>/example/haoshengyin/icon.jpg">
            <div class="gamebox">
                <div class="game">
                    <dl class="meta">
        ...
        <div class="page1-inputbox">
            ...
            <div class="inputlist">
                <span class="short-inputname">赛区</span>
                <span class="short-input">
                    <input id="user-name1" maxlength="7" type="text" class="input input-name" placeholder="请输入赛区">
                </span>
            </div>
           <div class="inputlist">
                <span class="short-inputname">称号</span>
                <span class="short-input">
                    <span id="select-text1" class="analog-select" data-value="1">优秀歌手称号</span>
                    <select class="select" id="select-list1" name="select1">
                        <option value="优秀歌手称号">优秀歌手称号</option>
                        <option value="最佳歌手称号">最佳歌手称号</option>
                    </select>
                </span>
            </div>
    ...
    <div id="page4" class="box">
        <div id="backtohomgpage" class="examplebox">
            <img class="exampleimg result" src="<?php echo $this->baseUrl;?>/example/haoshengyin/sample.jpg">
        </div>
    </div>
    <script>
